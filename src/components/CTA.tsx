...
export function CTA({
  ...
  body = "Finora is the missing layer between autonomous agents and the financial system — credit they can use, and control you can trust.",
  ctaLabel = "Try the live console →",
  ctaHref = "/console",
}: {
    ...
    <section className="mx-auto w-full max-w-7xl px-6 pb-24 sm:px-8">
      <div className="glow-accent relative overflow-hidden rounded-3xl border border-border bg-surface px-8 py-16 text-center sm:px-16">
        ...
        <div className="relative">
          ...
          <Link
            href={ctaHref}
            className="mt-8 inline-block rounded-full bg-accent px-7 py-3 text-sm font-semibold text-white transition-transform hover:scale-[1.03]"
          >
            {ctaLabel}
          </Link>
        </div>
